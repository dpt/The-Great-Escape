...
D $6F82 room29_second_tunnel_start
...
; suspect 4th byte could be a scaled height (would it be four times larger for internal coords?)
  $78D6 { BYTE_0(room_0_outdoors,           1), 0xB2, 0x8A,  6 },
  $78DA { BYTE_0(room_0_outdoors,           3), 0xB2, 0x8E,  6 },
  $78DE { BYTE_0(room_0_outdoors,           1), 0xB2, 0x7A,  6 },
  $78E2 { BYTE_0(room_0_outdoors,           3), 0xB2, 0x7E,  6 },
  $78E6 { BYTE_0(room_34,                   0), 0x8A, 0xB3,  6 },
  $78EA { BYTE_0(room_0_outdoors,           2), 0x10, 0x34, 12 },
  $78EE { BYTE_0(room_48,                   0), 0xCC, 0x79,  6 },
  $78F2 { BYTE_0(room_0_outdoors,           2), 0x10, 0x34, 12 },
  $78F6 { BYTE_0(room_28_hut1left,          1), 0xD9, 0xA3,  6 },
  $78FA { BYTE_0(room_0_outdoors,           3), 0x2A, 0x1C, 24 },
  $78FE { BYTE_0(room_1_hut1right,          0), 0xD4, 0xBD,  6 },
  $7902 { BYTE_0(room_0_outdoors,           2), 0x1E, 0x2E, 24 },
  $7906 { BYTE_0(room_2_hut2left,           1), 0xC1, 0xA3,  6 },
  $790A { BYTE_0(room_0_outdoors,           3), 0x2A, 0x1C, 24 },
  $790E { BYTE_0(room_3_hut2right,          0), 0xBC, 0xBD,  6 },
  $7912 { BYTE_0(room_0_outdoors,           2), 0x20, 0x2E, 24 },
  $7916 { BYTE_0(room_4_hut3left,           1), 0xA9, 0xA3,  6 },
  $791A { BYTE_0(room_0_outdoors,           3), 0x2A, 0x1C, 24 },
  $791E { BYTE_0(room_5_hut3right,          0), 0xA4, 0xBD,  6 },
  $7922 { BYTE_0(room_0_outdoors,           2), 0x20, 0x2E, 24 },
  $7926 { BYTE_0(room_21_corridor,          0), 0xFC, 0xCA,  6 },
  $792A { BYTE_0(room_0_outdoors,           2), 0x1C, 0x24, 24 },
  $792E { BYTE_0(room_20_redcross,          0), 0xFC, 0xDA,  6 },
  $7932 { BYTE_0(room_0_outdoors,           2), 0x1A, 0x22, 24 },
  $7936 { BYTE_0(room_15_uniform,           1), 0xF7, 0xE3,  6 },
  $793A { BYTE_0(room_0_outdoors,           3), 0x26, 0x19, 24 },
  $793E { BYTE_0(room_13_corridor,          1), 0xDF, 0xE3,  6 },
  $7942 { BYTE_0(room_0_outdoors,           3), 0x2A, 0x1C, 24 },
  $7946 { BYTE_0(room_8_corridor,           1), 0x97, 0xD3,  6 },
  $794A { BYTE_0(room_0_outdoors,           3), 0x2A, 0x15, 24 },
  $794E { BYTE_0(room_6,                    1), 0x00, 0x00,  0 }, // intriguing
  $7952 { BYTE_0(room_0_outdoors,           3), 0x22, 0x22, 24 },
  $7956 { BYTE_0(room_1_hut1right,          1), 0x2C, 0x34, 24 },
  $795A { BYTE_0(room_28_hut1left,          3), 0x26, 0x1A, 24 },
  $795E { BYTE_0(room_3_hut2right,          1), 0x24, 0x36, 24 },
  $7962 { BYTE_0(room_2_hut2left,           3), 0x26, 0x1A, 24 },
  $7966 { BYTE_0(room_5_hut3right,          1), 0x24, 0x36, 24 },
  $796A { BYTE_0(room_4_hut3left,           3), 0x26, 0x1A, 24 },
  $796E { BYTE_0(room_23_breakfast,         1), 0x28, 0x42, 24 },
  $7972 { BYTE_0(room_25_breakfast,         3), 0x26, 0x18, 24 },
  $7976 { BYTE_0(room_23_breakfast,         0), 0x3E, 0x24, 24 },
  $797A { BYTE_0(room_21_corridor,          2), 0x20, 0x2E, 24 },
  $797E { BYTE_0(room_19_food,              1), 0x22, 0x42, 24 },
  $7982 { BYTE_0(room_23_breakfast,         3), 0x22, 0x1C, 24 },
  $7986 { BYTE_0(room_18_radio,             1), 0x24, 0x36, 24 },
  $798A { BYTE_0(room_19_food,              3), 0x38, 0x22, 24 },
  $798E { BYTE_0(room_21_corridor,          1), 0x2C, 0x36, 24 },
  $7992 { BYTE_0(room_22_redkey,            3), 0x22, 0x1C, 24 },
  $7996 { BYTE_0(room_22_redkey,            1), 0x2C, 0x36, 24 },
  $799A { BYTE_0(room_24_solitary,          3), 0x2A, 0x26, 24 },
  $799E { BYTE_0(room_12_corridor,          1), 0x42, 0x3A, 24 },
  $79A2 { BYTE_0(room_18_radio,             3), 0x22, 0x1C, 24 },
  $79A6 { BYTE_0(room_17_corridor,          0), 0x3C, 0x24, 24 },
  $79AA { BYTE_0(room_7_corridor,           2), 0x1C, 0x22, 24 },
  $79AE { BYTE_0(room_15_uniform,           0), 0x40, 0x28, 24 },
  $79B2 { BYTE_0(room_14_torch,             2), 0x1E, 0x28, 24 },
  $79B6 { BYTE_0(room_16_corridor,          1), 0x22, 0x42, 24 },
  $79BA { BYTE_0(room_14_torch,             3), 0x22, 0x1C, 24 },
  $79BE { BYTE_0(room_16_corridor,          0), 0x3E, 0x2E, 24 },
  $79C2 { BYTE_0(room_13_corridor,          2), 0x1A, 0x22, 24 },
  $79C6 { BYTE_0(room_0_outdoors,           0), 0x44, 0x30, 24 },
  $79CA { BYTE_0(room_0_outdoors,           2), 0x20, 0x30, 24 },
  $79CE { BYTE_0(room_13_corridor,          0), 0x4A, 0x28, 24 },
  $79D2 { BYTE_0(room_11_papers,            2), 0x1A, 0x22, 24 },
  $79D6 { BYTE_0(room_7_corridor,           0), 0x40, 0x24, 24 },
  $79DA { BYTE_0(room_16_corridor,          2), 0x1A, 0x22, 24 },
  $79DE { BYTE_0(room_10_lockpick,          0), 0x36, 0x35, 24 },
  $79E2 { BYTE_0(room_8_corridor,           2), 0x17, 0x26, 24 },
  $79E6 { BYTE_0(room_9_crate,              0), 0x36, 0x1C, 24 },
  $79EA { BYTE_0(room_8_corridor,           2), 0x1A, 0x22, 24 },
  $79EE { BYTE_0(room_12_corridor,          0), 0x3E, 0x24, 24 },
  $79F2 { BYTE_0(room_17_corridor,          2), 0x1A, 0x22, 24 },
  $79F6 { BYTE_0(room_29_secondtunnelstart, 1), 0x36, 0x36, 24 },
  $79FA { BYTE_0(room_9_crate,              3), 0x38, 0x0A, 12 },
  $79FE { BYTE_0(room_52,                   1), 0x38, 0x62, 12 },
  $7A02 { BYTE_0(room_30,                   3), 0x38, 0x0A, 12 },
  $7A06 { BYTE_0(room_30,                   0), 0x64, 0x34, 12 },
  $7A0A { BYTE_0(room_31,                   2), 0x38, 0x26, 12 },
  $7A0E { BYTE_0(room_30,                   1), 0x38, 0x62, 12 },
  $7A12 { BYTE_0(room_36,                   3), 0x38, 0x0A, 12 },
  $7A16 { BYTE_0(room_31,                   0), 0x64, 0x34, 12 },
  $7A1A { BYTE_0(room_32,                   2), 0x0A, 0x34, 12 },
  $7A1E { BYTE_0(room_32,                   1), 0x38, 0x62, 12 },
  $7A22 { BYTE_0(room_33,                   3), 0x20, 0x34, 12 },
  $7A26 { BYTE_0(room_33,                   1), 0x40, 0x34, 12 },
  $7A2A { BYTE_0(room_35,                   3), 0x38, 0x0A, 12 },
  $7A2E { BYTE_0(room_35,                   0), 0x64, 0x34, 12 },
  $7A32 { BYTE_0(room_34,                   2), 0x0A, 0x34, 12 },
  $7A36 { BYTE_0(room_36,                   0), 0x64, 0x34, 12 },
  $7A3A { BYTE_0(room_35,                   2), 0x38, 0x1C, 12 },
  $7A3E { BYTE_0(room_37,                   0), 0x3E, 0x22, 24 },
  $7A42 { BYTE_0(room_2_hut2left,           2), 0x10, 0x34, 12 },
  $7A46 { BYTE_0(room_38,                   0), 0x64, 0x34, 12 },
  $7A4A { BYTE_0(room_37,                   2), 0x10, 0x34, 12 },
  $7A4E { BYTE_0(room_39,                   1), 0x40, 0x34, 12 },
  $7A52 { BYTE_0(room_38,                   3), 0x20, 0x34, 12 },
  $7A56 { BYTE_0(room_40,                   0), 0x64, 0x34, 12 },
  $7A5A { BYTE_0(room_38,                   2), 0x38, 0x54, 12 },
  $7A5E { BYTE_0(room_40,                   1), 0x38, 0x62, 12 },
  $7A62 { BYTE_0(room_41,                   3), 0x38, 0x0A, 12 },
  $7A66 { BYTE_0(room_41,                   0), 0x64, 0x34, 12 },
  $7A6A { BYTE_0(room_42,                   2), 0x38, 0x26, 12 },
  $7A6E { BYTE_0(room_41,                   1), 0x38, 0x62, 12 },
  $7A72 { BYTE_0(room_45,                   3), 0x38, 0x0A, 12 },
  $7A76 { BYTE_0(room_45,                   0), 0x64, 0x34, 12 },
  $7A7A { BYTE_0(room_44,                   2), 0x38, 0x1C, 12 },
  $7A7E { BYTE_0(room_43,                   1), 0x20, 0x34, 12 },
  $7A82 { BYTE_0(room_44,                   3), 0x38, 0x0A, 12 },
  $7A86 { BYTE_0(room_42,                   1), 0x38, 0x62, 12 },
  $7A8A { BYTE_0(room_43,                   3), 0x20, 0x34, 12 },
  $7A8E { BYTE_0(room_46,                   0), 0x64, 0x34, 12 },
  $7A92 { BYTE_0(room_39,                   2), 0x38, 0x1C, 12 },
  $7A96 { BYTE_0(room_47,                   1), 0x38, 0x62, 12 },
  $7A9A { BYTE_0(room_46,                   3), 0x20, 0x34, 12 },
  $7A9E { BYTE_0(room_50,                   0), 0x64, 0x34, 12 },
  $7AA2 { BYTE_0(room_47,                   2), 0x38, 0x56, 12 },
  $7AA6 { BYTE_0(room_50,                   1), 0x38, 0x62, 12 },
  $7AAA { BYTE_0(room_49,                   3), 0x38, 0x0A, 12 },
  $7AAE { BYTE_0(room_49,                   0), 0x64, 0x34, 12 },
  $7AB2 { BYTE_0(room_48,                   2), 0x38, 0x1C, 12 },
  $7AB6 { BYTE_0(room_51,                   1), 0x38, 0x62, 12 },
  $7ABA { BYTE_0(room_29_secondtunnelstart, 3), 0x20, 0x34, 12 },
  $7ABE { BYTE_0(room_52,                   0), 0x64, 0x34, 12 },
  $7AC2 { BYTE_0(room_51,                   2), 0x38, 0x54, 12 },
